...
# Can a machine learning project be implemented to predict the salaries of baseball players,
# given their salary information and career statistics from 1986?

# Dataset Story

# This dataset was originally taken from the StatLib library at Carnegie Mellon University.
# It is a part of the data used in the 1988 ASA Graphics Section Poster Session.
# The salary data was originally obtained from Sports Illustrated, April 20, 1987.
...
# AtBat: The number of times a baseball bat is used to hit a ball during the 1986-1987 season
# Hits: The number of successful hits during the 1986-1987 season
# HmRun: The number of the most valuable hits in the 1986-1987 season
# Runs: The number of points earned for the team during the 1986-1987 season
# RBI: The number of players who scored as a result of a batter's hit
# Walks: The number of mistakes made by the opposing player
# Years: The number of years the player has played in the major league
# CAtBat: The number of times the player has hit the ball during their career
# CHits: The number of successful hits during the player's career
# CHmRun: The player's most valuable hit throughout their career
# CRuns: The number of points the player earned for the team during their career
# CRBI: The number of players who scored as a result of the player's hits during their career
# CWalks: The number of mistakes made by the opposing player throughout the player's career
# League: A factor with levels A and N indicating the league the player played in until the end of the season
# Division: A factor with levels E and W indicating the player's position at the end of the 1986 season
# PutOuts: Assistance during the game with teammates
# Assists: The number of assists made by the player during the 1986-1987 season
# Errors: The number of mistakes made by the player during the 1986-1987 season
# Salary: The player's salary during the 1986-1987 season (in thousands)
# NewLeague: A factor with levels A and N indicating the player's league at the start of the 1987 season
...
def grab_col_names(dataframe, cat_th=10, car_th=20):
    """
    Returns the names of categorical, numerical, and cardinal variables in the dataset.
    Note: Numerical-looking categorical variables are included in the categorical variables.
    ...
    ------
        ...
        The sum of the three lists returned equals the total number of variables: cat_cols + num_cols + cat_but_car = number of variables
